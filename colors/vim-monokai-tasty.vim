...
let s:purple_slate = { 'cterm': 60, 'gui': '#1f5f87' }
...
call Highlight('StatusLineNormalMode', { 'fg': s:charcoal, 'bg': s:light_green, 'style': s:bold })
call Highlight('StatusLineVisualMode', { 'fg': s:charcoal, 'bg': s:purple, 'style': s:bold })
call Highlight('StatusLineInsertMode', { 'fg': s:charcoal, 'bg': s:yellow, 'style': s:bold })
call Highlight('StatusLineCommandMode', { 'fg': s:charcoal, 'bg': s:light_blue, 'style': s:bold })
...
call Highlight('VimwikiItalicChar', { 'fg': s:none, 'bg': s:none, 'style': s:none })
